# MRPL Problem Statement 26117 — Immutable Ground Truth
...
4. **A multimodal task** involving image or scanned document understanding (P&IDs, handwritten logs, drawings).
